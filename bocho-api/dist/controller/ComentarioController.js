...
var ComentarioController = /** @class */ (function () {
    ...
    ComentarioController.newComentario = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, descripcion, id, fecha, comentarioRepo, comentario, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    id = req.params.id;
                    fecha = new Date();
                    comentarioRepo = typeorm_1.getRepository(Comentario_1.Comentario);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, comentarioRepo
                            .createQueryBuilder()
                            .insert()
                            .into(Comentario_1.Comentario)
                            .values([{
                                userId: userId,
                ...
                return [2 /*return*/, res.status(200).json({ message: "se creo el comentario" })];
            }
        });
    }); };
    ComentarioController.getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, comentarioRepo, comentarios, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                ...
                case 3:
                    ...
                    console.log("e: ", e_2);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/, res.status(200).send(comentarios)];
            }
        });
    }); };
