...
var UserController = /** @class */ (function () {
    ...
    UserController.newUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, user, fecha, errors, userRepo, e_3;
    ...
    UserController.editUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, id, username, userRepo, fecha, e_4, errors, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                ...
                case 4: return [4 /*yield*/, class_validator_1.validate(user)];
                case 5:
                    errors = _a.sent();
                    if (errors.length > 0) {
                        return [2 /*return*/, res.status(400).json(errors)];
